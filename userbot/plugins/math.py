...
from userbot import bot as PYTHONBOT


@PYTHONBOT.on(admin_cmd(pattern="sin ?(.*)"))
@PYTHONBOT.on(sudo_cmd(pattern="sin ?(.*)", allow_sudo=True))
...
@PYTHONBOT.on(admin_cmd(pattern="cos ?(.*)"))
@PYTHONBOT.on(sudo_cmd(pattern="cos ?(.*)", allow_sudo=True))
...
@PYTHONBOT.on(admin_cmd(pattern="tan ?(.*)"))
@PYTHONBOT.on(sudo_cmd(pattern="tan ?(.*)", allow_sudo=True))
...
@PYTHONBOT.on(admin_cmd(pattern="cosec ?(.*)"))
@PYTHONBOT.on(sudo_cmd(pattern="cosec ?(.*)", allow_sudo=True))
...
@PYTHONBOT.on(admin_cmd(pattern="sec ?(.*)"))
@PYTHONBOT.on(sudo_cmd(pattern="sec ?(.*)", allow_sudo=True))
...
@PYTHONBOT.on(admin_cmd(pattern="cot ?(.*)"))
@PYTHONBOT.on(sudo_cmd(pattern="cot ?(.*)", allow_sudo=True))
...
@PYTHONBOT.on(admin_cmd(pattern="square ?(.*)"))
@PYTHONBOT.on(sudo_cmd(pattern="square ?(.*)", allow_sudo=True))
...
@PYTHONBOT.on(admin_cmd(pattern="cube ?(.*)"))
@PYTHONBOT.on(sudo_cmd(pattern="cube ?(.*)", allow_sudo=True))
